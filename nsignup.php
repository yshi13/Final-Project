...
?>
		...
		<div class="container">	
			...
			<!-- Page header -->
			<h1><font size=6 style="font-family:'Ubuntu'; color: white">Create an account - NPO</font></h1>
			<br>
			&nbsp;
...
//	print_r($_POST);
	...
	echo "\t<br><font size=5 style='font: Ubuntu; color: #6c6c76; margin-top:400px;'><strong>The user " . $email . " was added to the database</strong></font></div><br><br>\n";
